...
public class ArrayListPractice {
    public static void main (String[] args) {
        ...
        ArrayListPractice.printLettersWithFiveLetters(wordsToSearch, searchLength);
    }
    ...
    public static void printLettersWithFiveLetters(ArrayList<String> words, Integer searchLength) {
